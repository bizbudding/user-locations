...
class User_Locations_Show_Address extends WP_Widget {
	...
	function __construct() {
		$widget_options = array(
			...
			'description' => __( 'Shows address of locations in Schema.org standards.', 'user_locationsschool' ),
		);
		parent::__construct( false, $name = __( 'User_Locations - Show Address', 'user_locationsschool' ), $widget_options );
	}
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'user_locationsschool' ); ?></label>
		...
		<?php if ( wpseo_has_multiple_locations() ) { ?>
			<p>
				<label
					for="<?php echo $this->get_field_id( 'location_id' ); ?>"><?php _e( 'Location:', 'user_locationsschool' ); ?></label>
				<?php
				$args      = array(
				...
				<select name="<?php echo $this->get_field_name( 'location_id' ); ?>" id="<?php echo $this->get_field_id( 'location_id' ); ?>">
					...
					if ( ! empty( $locations ) ) {
						?>
						<option value=""><?php _e( 'Select a location', 'user_locationsschool' ); ?></option>
						<option value="current" <?php selected( $cur_location_id, 'current' ); ?>><?php _e( 'Use current location', 'user_locationsschool' ); ?></option>
						<?php
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_country' ); ?>">
				...
				<?php _e( 'Show country', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_state' ); ?>">
				...
				<?php _e( 'Show state', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_phone' ); ?>">
				...
				<?php _e( 'Show phone number', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_phone_2' ); ?>">
				...
				<?php _e( 'Show second phone number', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_fax' ); ?>">
				...
				<?php _e( 'Show fax number', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_email' ); ?>">
				...
				<?php _e( 'Show email address', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_logo' ); ?>">
				...
				<?php _e( 'Show logo', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_vat' ); ?>">
				...
				<?php _e( 'Show VAT ID', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_tax' ); ?>">
				...
				<?php _e( 'Show Tax ID', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_coc' ); ?>">
				...
				<?php _e( 'Show Chamber of Commerce ID', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_opening_hours' ); ?>">
				...
				<?php _e( 'Show opening hours', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'hide_closed' ); ?>">
				...
				<?php _e( 'Hide closed days', 'user_locationsschool' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_oneline' ); ?>">
				...
				<?php _e( 'Show address in one line', 'user_locationsschool' ); ?>
			</label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'comment' ); ?>"><?php _e( 'Extra comment', 'user_locationsschool' ); ?></label>
